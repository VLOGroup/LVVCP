...
python demo_LVVCP.py \
    --cfg_strict_reload=1 \
    --out_path=out_val/ \
    --load_path=data_and_model_samples/DAVIS2017_scootergray/res_mm1_ep400/model/mm1__ep400_3Cands12ItersModel_p2.ckpt \
...
echo "  python numerical_quick_check.py --sample_cv=0 --res_path=out_val/<results_folder_name>/"
printf "\n\n"
